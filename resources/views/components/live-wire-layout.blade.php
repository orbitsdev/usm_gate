          ...
          <ul role="list" class="flex flex-1 flex-col gap-y-7">
            ...
            <li>
              <ul role="list" class="-mx-2 space-y-1">
                ...
                <li>
                  <!-- Current: "bg-gray-50 text-yellow-600", Default: "text-gray-700 hover:text-yellow-600 hover:bg-gray-50" -->
                  <a href="{{route('usm.dashboard')}}"  class="{{request()->routeIs('usm.dashboard') ? 'bg-gray-50 text-yellow-600 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold': ' text-gray-700 hover:text-yellow-600 hover:bg-gray-50 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold' }}  ">
                ...
                <li>
                  <a href="{{route('account-types')}}"  class="{{request()->routeIs('account-types') ? 'bg-gray-50 text-yellow-600 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold': ' text-gray-700 hover:text-yellow-600 hover:bg-gray-50 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold' }}  ">
          ...
          <div class="flex items-center gap-x-4 lg:gap-x-6">
            ...
            <div x-data="{ isOpen: false }" class="relative">
                <button type="button" @click="isOpen = !isOpen" class="-m-1.5 flex items-center p-1.5" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                    ...
                    <a href="{{ Storage::disk('public')->url(Auth::user()->profile_photo_path) }}" target="_blank" class="h-8 w-8 rounded-full bg-yellow-600 text-white flex items-center justify-center overflow-hidden">
                        <img src="{{ Storage::disk('public')->url(Auth::user()->profile_photo_path) }}" alt="" class="w-full h-full object-cover rounded-full">
                    </a>
                @else
                ...
                @endif
                    ...
                    <span class="hidden lg:flex lg:items-center">
                      <span class="ml-4 text-sm font-semibold leading-6 text-gray-900 truncate" aria-hidden="true">{{ Str::limit(auth()->user()->name, 20) }}</span>
