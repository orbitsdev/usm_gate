<div class="min-h-screen flex flex-col items-center justify-center relative" style="background: url('{{ asset('images/usm-administrator.png') }}') center/cover no-repeat;">
