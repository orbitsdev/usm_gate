<table align="left">
    <thead>
        <tr  style="background-color: #006100; color: white" >
            ...
            <th  style="background-color: #006100; color: white; ">FR ID</th>
            <th  style="background-color: #006100; color: white; ">School ID</th>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td align="left" width="40">{{ $item?->qr_number ?? ''}}</td>
            {{-- <td align="left" width="40">{{ $item?->account_id ?? ''}}</td> --}}
            <td align="left" width="40">
                @if(!empty($item->account))
                {{ $item?->account?->unique_id ?? ''}}
                @endif
            </td>
