                ...
                @if ($transaction->card)
                    ...
                    @else
                        <div class="flex flex-col items-center">
                            ...
                            <p class="text-3xl font-bold">No Account Was Assined In The Card </p>
                        </div>
                    @endif
                @else
                    <div class="flex flex-col items-center">
                       ...
                       C499.5,480.7,531.3,438.3,499.5,385.4z M298.4,438.3h-84.7v-84.7h84.7V438.3z M298.4,311.3h-84.7V120.7h84.7V311.3z" />
                        ...
                        <p class="text-3xl font-bold">No card Found</p>
                    </div>
                @endif
            @else
                <div class="flex flex-col items-center">
                    ...
                    <p class="text-3xl font-bold">Scan Your Card at the Gate</p>
                </div>
            @endif
        </div>
    </div>
